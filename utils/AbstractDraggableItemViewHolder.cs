...
{
    public abstract class AbstractDraggableItemViewHolder : RecyclerView.ViewHolder, IDraggableItemViewHolder
    {
        private readonly DraggableItemState mDragState = new DraggableItemState();
        public AbstractDraggableItemViewHolder(View itemView) : base(itemView)
        {
        }
        public AbstractDraggableItemViewHolder(IntPtr handle, JniHandleOwnership ownership) : base(handle, ownership)
        {
        }
